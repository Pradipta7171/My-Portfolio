        ...
        <div className="relative">
          ...
          >
            <Image src="/Picture1.jpg" alt="Profile"
              ...
              quality={100}
              priority={true}
              className="h-24.2 w-24.2 rounded-full object-cover border-[0.35rem]  border-indigo-200 dark:border-violet-200 shadow-xl"
            />
          </motion.div>

          <motion.span className="absolute bottom-3 right-0 text-3xl"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{
              type: "spring",
